...
static const xtun_cfg_node_s cfgNodes[] = {
    ...
    { CONF_ID(1),
        ...
        .srv = { .mtu = XGW_XTUN_NODE_1_SRV_MTU, .pkts = XGW_XTUN_NODE_1_SRV_PKTS, .cryptoAlgo = XTUN_CRYPTO_ALGO_NULL0, .paths = {
            { .itfc = XGW_XTUN_NODE_1_SRV_PATH_0_ITFC, .band = XGW_XTUN_NODE_1_SRV_PATH_0_BAND, .mac = XGW_XTUN_NODE_1_SRV_PATH_0_MAC, .gw = XGW_XTUN_NODE_1_SRV_PATH_0_GW, .addr = {XGW_XTUN_NODE_1_SRV_PATH_0_ADDR_0,XGW_XTUN_NODE_1_SRV_PATH_0_ADDR_1,XGW_XTUN_NODE_1_SRV_PATH_0_ADDR_2,XGW_XTUN_NODE_1_SRV_PATH_0_ADDR_3}, .tos = XGW_XTUN_NODE_1_SRV_PATH_0_TOS, .ttl = XGW_XTUN_NODE_1_SRV_PATH_0_TTL, .port = PORT(1, 0), },
#if XTUN_PATHS_N > 1
